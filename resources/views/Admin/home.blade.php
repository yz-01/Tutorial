...
<html lang="en" class="light">
    ...
    <body class="main">
        ...
        <div class="flex">
            <!-- BEGIN: Side Menu -->
            <nav class="side-nav">
                <a href="index.html" class="intro-x flex items-center pl-5 pt-4">
                    <img alt="Rubick Tailwind HTML Admin Template" class="w-6" src="{{ asset('Template/images/logo.svg') }}">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.html">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="index.html" class="breadcrumb--active">Dashboard</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    <div class="intro-x relative mr-3 sm:mr-6">
                        ...
                        <a class="notification sm:hidden" href="index.html"> <i data-feather="search" class="notification__icon dark:text-gray-300"></i> </a>
                        <div class="search-result">
                            <div class="search-result__content">
                                ...
                                <div class="mb-5">
                                    ...
                                    <a href="index.html" class="flex items-center mt-2">
                                ...
                                <div class="mb-5">
                                    <a href="index.html" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/profile-3.jpg') }}">
                                        </div>
                                    ...
                                    <a href="index.html" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/profile-14.jpg') }}">
                                        </div>
                                    ...
                                    <a href="index.html" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/profile-7.jpg') }}">
                                        </div>
                                    ...
                                    <a href="index.html" class="flex items-center mt-2">
                                        <div class="w-8 h-8 image-fit">
                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/profile-5.jpg') }}">
                                        </div>
                                ...
                                <a href="index.html" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/preview-8.jpg') }}">
                                    </div>
                                ...
                                <a href="index.html" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/preview-13.jpg') }}">
                                    </div>
                                ...
                                <a href="index.html" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/preview-6.jpg') }}">
                                    </div>
                                ...
                                <a href="index.html" class="flex items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/preview-7.jpg') }}">
                                    </div>
                    ...
                    <div class="intro-x dropdown mr-auto sm:mr-6">
                        ...
                        <div class="notification-content pt-2 dropdown-menu">
                            <div class="notification-content__box dropdown-menu__content box dark:bg-dark-6">
                                ...
                                <div class="cursor-pointer relative flex items-center mt-5">
                                    <div class="w-12 h-12 flex-none image-fit mr-1">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-full" src="{{ asset('Template/images/profile-8.jpg') }}">
                                        <div class="w-3 h-3 bg-theme-9 absolute right-0 bottom-0 rounded-full border-2 border-white"></div>
                                    </div>
                                    <div class="ml-2 overflow-hidden">
                                        <div class="flex items-center">
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false">
                            <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-8.jpg') }}">
                        </div>
                        <div class="dropdown-menu w-56">
                            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                                ...
                                <div class="p-2">
                                    <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                                    <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="edit" class="w-4 h-4 mr-2"></i> Add Account </a>
                                    <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                                    <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="help-circle" class="w-4 h-4 mr-2"></i> Help </a>
                                </div>
                                <div class="p-2 border-t border-theme-27 dark:border-dark-3">
                                    <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                                    ...
                                    <div class="flex flex-col xl:flex-row xl:items-center">
                                        ...
                                        <div class="dropdown xl:ml-auto mt-5 xl:mt-0">
                                            ...
                                            <div class="dropdown-menu w-40">
                                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2 overflow-y-auto h-32"> <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">PC & Laptop</a> <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">Smartphone</a> <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">Electronic</a> <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">Photography</a> <a href="index.html" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md">Sport</a> </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                                <div class="intro-y flex items-center h-10">
                                    ...
                                    <a href="index.html" class="ml-auto text-theme-1 dark:text-theme-10 truncate">Show More</a> 
                                </div>
                            ...
                            <div class="col-span-12 xl:col-span-8 mt-6">
                                ...
                                <div class="intro-y box p-5 mt-12 sm:mt-5">
                                    ...
                                    <div class="report-maps mt-5 bg-gray-200 rounded-md" data-center="-6.2425342, 106.8626478" data-sources="/{{ asset('Template/json/location.json') }}"></div>
                                </div>
                            </div>
                            <!-- END: Official Store -->
                            ...
                            <div class="col-span-12 xl:col-span-4 mt-6">
                                ...
                                <div class="mt-5">
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-3.jpg') }}">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                                <div class="font-medium">Tom Cruise</div>
                                                <div class="text-gray-600 text-xs mt-0.5">14 October 2020</div>
                                            </div>
                                    ...
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-6.jpg') }}">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                                <div class="font-medium">Russell Crowe</div>
                                                <div class="text-gray-600 text-xs mt-0.5">18 December 2021</div>
                                            </div>
                                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="ml-4 mr-auto">
                                                ...
                                                <div class="text-gray-600 text-xs mt-0.5">19 March 2021</div>
                                            </div>
                                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <div class="intro-y">
                                        <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                            <div class="w-10 h-10 flex-none image-fit rounded-md overflow-hidden">
                                                <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-12.jpg') }}">
                                            </div>
                                            <div class="ml-4 mr-auto">
                                                <div class="font-medium">Robert De Niro</div>
                                                <div class="text-gray-600 text-xs mt-0.5">5 October 2022</div>
                                            </div>
                                            <div class="py-1 px-2 rounded-full text-xs bg-theme-9 text-white cursor-pointer font-medium">137 Sales</div>
                                        </div>
                                    </div>
                                    <a href="index.html" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600">View More</a> 
                                </div>
                            </div>
                            ...
                            <div class="col-span-12 mt-6">
                                        ...
                                        <tbody>
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-4.jpg') }}" title="Uploaded at 14 October 2020">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-14.jpg') }}" title="Uploaded at 26 May 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-1.jpg') }}" title="Uploaded at 18 October 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="index.html" class="font-medium whitespace-nowrap">Apple MacBook Pro 13</a> 
                                                ...
                                                <td class="table-report__action w-56">
                                                    <div class="flex justify-center items-center">
                                                        <a class="flex items-center mr-3" href="index.html"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                                        <a class="flex items-center text-theme-6" href="index.html"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-3.jpg') }}" title="Uploaded at 18 December 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-8.jpg') }}" title="Uploaded at 6 December 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-7.jpg') }}" title="Uploaded at 23 April 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="index.html" class="font-medium whitespace-nowrap">Sony A7 III</a> 
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-15.jpg') }}" title="Uploaded at 19 March 2021">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-8.jpg') }}" title="Uploaded at 24 January 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-2.jpg') }}" title="Uploaded at 30 July 2020">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="index.html" class="font-medium whitespace-nowrap">Dell XPS 13</a> 
                                                    <div class="text-gray-600 text-xs whitespace-nowrap mt-0.5">PC &amp; Laptop</div>
                                                </td>
                                            ...
                                            <tr class="intro-x">
                                                <td class="w-40">
                                                    <div class="flex">
                                                        <div class="w-10 h-10 image-fit zoom-in">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-10.jpg') }}" title="Uploaded at 5 October 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-2.jpg') }}" title="Uploaded at 20 September 2022">
                                                        </div>
                                                        <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="tooltip rounded-full" src="{{ asset('Template/images/preview-7.jpg') }}" title="Uploaded at 5 March 2021">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="index.html" class="font-medium whitespace-nowrap">Nike Air Max 270</a> 
                                ...
                                <div class="intro-y flex flex-wrap sm:flex-row sm:flex-nowrap items-center mt-3">
                                    <ul class="pagination">
                                        <li>
                                            <a class="pagination__link" href="index.html"> <i class="w-4 h-4" data-feather="chevrons-left"></i> </a>
                                        </li>
                                        <li>
                                            <a class="pagination__link" href="index.html"> <i class="w-4 h-4" data-feather="chevron-left"></i> </a>
                                        </li>
                                        <li> <a class="pagination__link" href="index.html">...</a> </li>
                                        <li> <a class="pagination__link" href="index.html">1</a> </li>
                                        <li> <a class="pagination__link pagination__link--active" href="index.html">2</a> </li>
                                        <li> <a class="pagination__link" href="index.html">3</a> </li>
                                        <li> <a class="pagination__link" href="index.html">...</a> </li>
                                        <li>
                                            <a class="pagination__link" href="index.html"> <i class="w-4 h-4" data-feather="chevron-right"></i> </a>
                                        </li>
                                        <li>
                                            <a class="pagination__link" href="index.html"> <i class="w-4 h-4" data-feather="chevrons-right"></i> </a>
                                        </li>
                                    </ul>
                            ...
                            <div class="xxl:pl-6 grid grid-cols-12 gap-6">
                                        ...
                                        <div class="intro-x">
                                            <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                                ...
                                                <div class="ml-4 mr-auto">
                                                    ...
                                                    <div class="text-gray-600 text-xs mt-0.5">9 January 2022</div>
                                                </div>
                                                <div class="text-theme-6">-$144</div>
                                            </div>
                                        </div>
                                        <a href="index.html" class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600">View More</a> 
                                    </div>
                                </div>
                                <!-- END: Transactions -->
                                ...
                                <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
                                    ...
                                    <div class="report-timeline mt-5 relative">
                                        ...
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-7.jpg') }}">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                <div class="flex items-center">
                                                ...
                                                <div class="text-gray-600">
                                                    ...
                                                    <div class="flex mt-2">
                                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Apple MacBook Pro 13">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ asset('Template/images/preview-7.jpg') }}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Sony A7 III">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ asset('Template/images/preview-5.jpg') }}">
                                                        </div>
                                                        <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                            <img alt="Rubick Tailwind HTML Admin Template" class="rounded-md border border-white" src="{{ asset('Template/images/preview-8.jpg') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="intro-x relative flex items-center mb-3">
                                            ...
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                ...
                                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark:text-theme-10" href="index.html">Sony A7 III</a> price and description</div>
                                            </div>
                                        </div>
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" src="{{ asset('Template/images/profile-15.jpg') }}">
                                                </div>
                                            </div>
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                <div class="flex items-center">
                                                ...
                                                <div class="text-gray-600 mt-1">Has changed <a class="text-theme-1 dark:text-theme-10" href="index.html">Sony Master Series A9G</a> description</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 xl:col-start-1 xl:row-start-2 xxl:col-start-auto xxl:row-start-auto mt-3">
                                    <div class="intro-x flex items-center h-10">
                                        ...
                                        <a href="index.html" class="ml-auto text-theme-1 dark:text-theme-10 truncate flex items-center"> <i data-feather="plus" class="w-4 h-4 mr-1"></i> Add New Schedules </a>
                                    </div>
                                    <div class="mt-5">
